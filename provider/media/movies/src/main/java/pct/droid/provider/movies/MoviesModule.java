...
//    }
    ...
    @Provides @ProviderScope MoviesService provideMoviesService(Retrofit retrofit) {
        return retrofit.create(MoviesService.class);
    }

    @Provides @ProviderScope MoviesProvider provideMovies(MoviesService service) {
        return new MoviesProvider(service);
    }
